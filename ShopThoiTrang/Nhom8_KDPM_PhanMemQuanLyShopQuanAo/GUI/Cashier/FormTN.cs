...
namespace GUI
{
    public partial class FormTN : DevExpress.XtraBars.FluentDesignSystem.FluentDesignForm
    {
        ...
        public formSanPham frmSP = null;
        public HOADON gioHang = null;
        public List<CartItem> chiTietGioHang = null;
        NhanVien_BLLDAL nvBLL = new NhanVien_BLLDAL();
        public formCart _frmCard= null;
        ...
        private void ItemProduct_Click(object sender, EventArgs e)
        {
            ...
            frmSP = new formSanPham(int.Parse(ctr.Tag.ToString()));
            this.container.Controls.Add(frmSP);
        ...
        public void checkBuy(int number)
        {
            if (flagBuy == true)
            {
                flagBuy = false;
                Program.soLuong+=number;
                this.barButtonItemCart.Caption = "CART(" + Program.soLuong.ToString() + ")";
            }
        }
        ...
        public void visibleBillCreating(bool f)
        {
            this.accordionControlElementBill.Visible = f;
        }
        ...
        private void barButtonItemCart_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.container.Controls.Clear();
            _frmCard = new formCart();
            this.container.Controls.Add(_frmCard);
            _frmCard.Dock = DockStyle.Fill;
            this.itemNav.Caption = $"{barButtonItemCart.Caption}";
        }
        ...
        private void accordionControlElementCard_Click(object sender, EventArgs e)
        {
            this.container.Controls.Clear();
            FormTaoKH frmKH = new FormTaoKH();
            this.container.Controls.Add(frmKH);
            frmKH.Dock = DockStyle.Fill;
            this.itemNav.Caption = $"{accordionControlElementCard.Text}";
        }

        private void accordionControlElementListCustomer_Click(object sender, EventArgs e)
        {
            this.container.Controls.Clear();
            FormListOfCustomer frm = new FormListOfCustomer();
            this.container.Controls.Add(frm);
            frm.Dock = DockStyle.Fill;
            this.itemNav.Caption = $"{accordionControlElementListCustomer.Text}";
        }

        private void accordionControlElementInformation_Click(object sender, EventArgs e)
        {
            this.container.Controls.Clear();
            formTaiKhoan frm = new formTaiKhoan(nvBLL.load_OnlyNhanVien((int)Program.frmLogin.TaiKhoan.MANHANVIEN));
            this.container.Controls.Add(frm);
            frm.Dock = DockStyle.Fill;
            this.itemNav.Caption = $"{accordionControlElementInformation.Text}";
        }
        ...
        private void accordionControlElementChangePassword_Click(object sender, EventArgs e)
        {
            ...
            this.container.Controls.Add(frm);
            frm.Dock = DockStyle.Fill;
            this.itemNav.Caption = $"{accordionControlElementChangePassword.Text}";
        }

        private void btnClearCart_ItemClick(object sender, ItemClickEventArgs e)
        {
            if (gioHang == null)
            {
                MessageBox.Show("Giỏ hàng rỗng nên không thể xóa!", "Vui lòng tạo giỏ hàng");
                return;
            }
            ...
            checkBuy(0);
            splashScreenManager1.ShowWaitForm();
            frmSP = new formSanPham(0);
            gioHang = null;
            chiTietGioHang = null;
            Program.formTN.container.Controls.Clear();
            this.container.Controls.Add(frmSP);
            frmSP.Dock = DockStyle.Fill;
            this.itemNav.Caption = "TẤT CẢ CÁC LOẠI SẢN PHẨM";
            splashScreenManager1.CloseWaitForm();
            MessageBox.Show("Xóa hóa đơn thành công. Hóa đơn đã được tạo mới.", "Reset Cart");
        }

        private void accordionControlElementBill_Click(object sender, EventArgs e)
        {
            this.container.Controls.Clear();
            Program.formTN._frmCard = new formCart();
            this.container.Controls.Add(Program.formTN._frmCard);
            Program.formTN._frmCard.Dock = DockStyle.Fill;
            this.itemNav.Caption = $"{barButtonItemCart.Caption}";
        }
